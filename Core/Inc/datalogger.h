...
#define FLASH_RING_BUFFER_SIZE CONFIG_DATALOGGER_FLASH_RING_BUFFER_SIZE
...
=======
#define DATA_LOGGER_QUEUE_SIZE CONFIG_DATALOGGER_QUEUE_SIZE
>>>>>>> 7a8ab737b2e350dd096e98fab5f8517cf1fb63a5
#define MAX_QUEUE_WAIT_MS 1000
#define QUEUE_SEND_TIMEOUT_MS 1000
=======
#define DATA_LOGGER_QUEUE_SIZE CONFIG_DATALOGGER_QUEUE_SIZE
#define MAX_QUEUE_WAIT_MS CONFIG_DATALOGGER_QUEUE_SEND_TIMEOUT_MS
#define QUEUE_SEND_TIMEOUT_MS CONFIG_DATALOGGER_QUEUE_SEND_TIMEOUT_MS
>>>>>>> Stashed changes

// MQTT transmission interval
#define MQTT_TRANSMISSION_INTERVAL_MS   CONFIG_DATALOGGER_MQTT_TRANSMISSION_INTERVAL_MS // 60 seconds
#define MAINTENANCE_FLUSH_INTERVAL_SEC  CONFIG_DATALOGGER_MAINTENANCE_FLUSH_INTERVAL_S
#define MAINTENANCE_STATUS_INTERVAL_SEC  CONFIG_DATALOGGER_MAINTENANCE_STATUS_INTERVAL_S
